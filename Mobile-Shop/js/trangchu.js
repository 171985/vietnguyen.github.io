window.onload = function () {
	...
	if (filters.length) { // có filter
		...
		// var soLuong = (window.innerWidth < 1200 ? 3 : 4); // màn hình nhỏ thì hiển thị 4 sp, to thì hiển thị 5
		var soLuong = 4;
		// Các màu
		...
		addKhungSanPham('NỔI BẬT NHẤT', yellow_red, ['star=3', 'sort=rateCount-decrease'], soLuong * 2);
		addKhungSanPham('SẢN PHẨM MỚI', blue, ['promo=moiramat', 'sort=rateCount-decrease'], soLuong * 2);
		addKhungSanPham('TRẢ GÓP 0%', yellow_red, ['promo=tragop'], soLuong * 2);
		addKhungSanPham('GIÁ SỐC ONLINE', blue, ['promo=giareonline'], soLuong * 2);
		addKhungSanPham('GIẢM GIÁ LỚN', yellow_red, ['promo=giamgia'], soLuong * 2);
		addKhungSanPham('GIÁ RẺ CHO MỌI NHÀ', blue, ['price=0-3000000', 'sort=price'], soLuong * 2);
	}

	// Thêm chọn mức giá
	addPricesRange(0, 2000000);
	addPricesRange(2000000, 4000000);
	addPricesRange(4000000, 8000000);
	addPricesRange(8000000, 13000000);
