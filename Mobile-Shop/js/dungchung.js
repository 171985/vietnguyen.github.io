	...
	<nav class="navbar navbar-expand-md navbar-light bg-light">
      <div class="container-fluid top-nav">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav top-nav-quicklink">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="index.html">
                <i class="fa fa-home"></i> Trang chủ</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="tintuc.html"><i class="fa fa-newspaper-o"></i> Tin tức</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="tuyendung.html"><i class="fa fa-handshake-o"></i> Tuyển dụng</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="gioithieu.html"><i class="fa fa-info-circle"></i> Giới thiệu</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="trungtambaohanh.html"><i class="fa fa-wrench"></i> Bảo hành</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="lienhe.html"><i class="fa fa-phone"></i> Liên hệ</a>
              </li>  
          </ul>
        </div>
      </div>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html">VN-Shop</a> - All rights reserved © 2021 - Designed by
            <span style="color: #eee; font-weight: bold">VN-Shop</span></p>
    </div>`);
}
...
function addPlc() {
    ...
    <div class="plc">
        <section>
            <ul class="flexContain row">
                <li class="sanPham col-12 col-sm-6 col-md-4  col-lg-3">Giao hàng hỏa tốc trong 1 giờ</li>
                <li class="sanPham col-12 col-sm-6 col-md-4  col-lg-3">Thanh toán linh hoạt: tiền mặt, visa / master, trả góp</li>
                <li class="sanPham col-12 col-sm-6 col-md-4  col-lg-3">Trải nghiệm sản phẩm tại nhà</li>
                <li class="sanPham col-12 col-sm-6 col-md-4  col-lg-3">Lỗi đổi tại nhà trong 1 ngày</li>
            </ul>
        </section>
    </div>`);
}
